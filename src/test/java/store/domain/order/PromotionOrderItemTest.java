...
class PromotionOrderItemTest {
    ...
    private PromotionOrderItem createPromotionOrderProduct(NormalProduct normalProduct, PromotionProduct promoProduct, int orderQuantity) {
        return new PromotionOrderItem(normalProduct, promoProduct, orderQuantity, LocalDateTime.now());
    }

    @Test
    @DisplayName("수량을 1 증가시킨다")
    void shouldIncreaseQuantityByOne() {
        PromotionOrderItem orderProduct = createPromotionOrderProduct(normalProduct, promoProductOnePlusOne, 5);
    ...
    class HasFallbackToNormalTests {
        ...
        void shouldReturnTrueWhenFallbackToNormalIsNeeded() {
            PromotionOrderItem orderProduct = createPromotionOrderProduct(normalProduct, promoProductOnePlusOne, 12);
        ...
        void shouldReturnFalseWhenFallbackToNormalIsNotNeeded() {
            PromotionOrderItem orderProduct = createPromotionOrderProduct(normalProduct, promoProductOnePlusOne, 8);
            Assertions.assertThat(orderProduct.hasFallbackToNormal()).isFalse();
        }
        ...
        void promotionOutOfStock() {
            ...
            PromotionOrderItem orderProduct = createPromotionOrderProduct(outOfStock, outOfStockPromoProduct, 10);
    ...
    class GetPromotedCountTests {
        ...
        void shouldReturnCorrectPromotedCountForOnePlusOne() {
            PromotionOrderItem orderProduct = createPromotionOrderProduct(normalProduct, promoProductOnePlusOne, 4);
        ...
        void shouldLimitPromotedCountByStock() {
            PromotionOrderItem orderProduct = createPromotionOrderProduct(normalProduct, promoProductOnePlusOne, 20);
        ...
        void shouldReturnCorrectPromotedCountForTwoPlusOne() {
            PromotionOrderItem orderProduct = createPromotionOrderProduct(normalProduct, promoProductTwoPlusOne, 4);
        ...
        void shouldReturnZeroForInsufficientOrderQuantityInTwoPlusOne() {
            PromotionOrderItem orderProduct = createPromotionOrderProduct(normalProduct, promoProductTwoPlusOne, 1);
    ...
    class HasUnclaimedFreeItemTests {
        ...
        void shouldReturnTrueWhenUnclaimedFreeItemExists() {
            PromotionOrderItem orderProduct = createPromotionOrderProduct(normalProduct, promoProductOnePlusOne, 3);
        ...
        void shouldReturnFalseWhenPromotionNotApplicable() {
            ...
            PromotionOrderItem orderProduct = createPromotionOrderProduct(normalProduct, expiredPromoProduct, 3);
    ...
    class HasEnoughStockTests {
        ...
        void shouldReturnTrueWhenStockIsEnough() {
            PromotionOrderItem orderProduct = createPromotionOrderProduct(normalProduct, promoProductOnePlusOne, 15);
